...
void mail::reg(int k)
{
    ...
    ofstream filout;
    filout.open("D:\\Practise Section\\car rental project with cpp\\User login and registration CPP\\registration.txt",ios::app|ios::binary);
    if(!filout)
    {
        cout<<"\nCannot open file\n";
    }
...
int main()
{
    ...
    ifstream filein;
    filein.open("D:\\Practise Section\\car rental project with cpp\\User login and registration CPP\\registration.txt",ios::in|ios::binary);
    if(!filein)
    {
